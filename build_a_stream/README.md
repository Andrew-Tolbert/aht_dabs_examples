...
The 'build_a_stream' project was generated by using the default-python template.
...
3. To deploy a development copy of this project, type:
    ...
    `[dev yourname] build_a_stream_job` to your workspace.
...
4. Similarly, to deploy a production copy, type:
   ...
   (defined in resources/build_a_stream.job.yml). The schedule
